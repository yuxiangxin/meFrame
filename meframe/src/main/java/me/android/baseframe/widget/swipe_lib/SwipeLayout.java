package me.android.baseframe.widget.swipe_lib;
...
public class SwipeLayout extends FrameLayout {
    ...
    public SwipeLayout (Context context, AttributeSet attrs) {
        ...
        boolean swipeAvailAble = ta.getBoolean(R.styleable.SwipeLayout_swipe_available, true);
        setSwipeAble(swipeAvailAble);
