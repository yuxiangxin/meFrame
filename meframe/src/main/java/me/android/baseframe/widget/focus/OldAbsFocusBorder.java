...
public abstract class OldAbsFocusBorder {}/*extends FrameLayout implements FocusBorder, ViewTreeObserver.OnGlobalFocusChangeListener {
    ...
    protected boolean mSupportHardware = true;

    protected OldAbsFocusBorder (Context context, Builder builder) {
        super(context);
    ...
    public void setSupportHardware (boolean supportHardware) {
        mSupportHardware = supportHardware;
    }
    ...
    *//**
    ...
    public void setVisible (boolean visible, boolean anim) {
        if (mIsVisible != visible) {
            ...
            if (!visible && hasOldFocus) {
                ...
                LogUtils.v(TAG, "!visible && hasOldFocus");
                mOldFocusView.clear();
                mOldFocusView = null;
            }
        }
    ...
    protected Rect findOffsetDescendantRectToMyCoords (View descendant) {
        ...
        // to cast into our coordinate space
        if (theParent == root) {
            rect.offset(descendant.getLeft() - descendant.getScrollX(),
                    descendant.getTop() - descendant.getScrollY());
        }
    ...
    *//**
    ...
    private static class RecyclerViewScrollListener extends RecyclerView.OnScrollListener {
        private WeakReference<OldAbsFocusBorder> mFocusBorder;
        private int mScrolledX = 0, mScrolledY = 0;

        public RecyclerViewScrollListener (OldAbsFocusBorder border) {
        ...
        *//*private View getFocused(RecyclerView recyclerView) {
        ...
        public void onScrollStateChanged (RecyclerView recyclerView, int newState) {
            if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                final OldAbsFocusBorder border = mFocusBorder.get();
    ...
    public static abstract class Builder {
        ...
        protected long mAnimDuration = OldAbsFocusBorder.DEFAULT_ANIM_DURATION_TIME;
        protected long mShimmerDuration = OldAbsFocusBorder.DEFAULT_SHIMMER_DURATION_TIME;
        protected long mBreathingDuration = OldAbsFocusBorder.DEFAULT_BREATHING_DURATION_TIME;
        ...
        protected long mTitleAnimDuration = OldAbsFocusBorder.DEFAULT_TITLE_ANIM_DURATION_TIME;
